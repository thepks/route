...
var jobs_service_config = {                                                                                                                                                        
    'host': process.env.VCAP_APPLICATION.cloudantNOSQLDB[0].credentials.host,                                                                                                      
    'port': process.env.VCAP_APPLICATION.cloudantNOSQLDB[0].credentials.port,                                                                                                                                                              
    'path': '/jobs',                                                                                                                                                          
    'username': process.env.VCAP_APPLICATION.cloudantNOSQLDB[0].credentials.username,                                                                                                                                   
    'password': process.env.VCAP_APPLICATION.credentials.password                                                                                                                                    
};                                                                                                                                                                            
